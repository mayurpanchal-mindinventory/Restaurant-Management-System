      ...
      <div className={`max-w-6xl mx-auto ${!showModal && `space-y-6`}`}>
        ...
        <div className="flex items-center justify-between pt-4">
          <button
            ...
            className="px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-50 disabled:opacity-40 shadow-sm transition-all"
          >
            Previous
          </button>
