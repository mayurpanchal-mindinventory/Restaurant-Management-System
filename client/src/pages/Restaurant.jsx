...
function Restaurant() {
  ...
  return restaurant?.length > 0 || searchTerm !== "" ? (
    <div className="w-full bg-white  text-black shadow-md rounded-xl p-4">
      <div className="my-4 text-end">
        {" "}
        <Link
          to={"add"}
          className="bg-gray-900 text-white px-4 py-2 rounded-lg  font-bold "
        >
          Add Restaurant
        </Link>
      </div>
    ...
    <>
      <div className="h-full flex text-gray-800 items-center justify-center">
        <p className="text-3xl font-bold">No Restaurant Yet</p>
      </div>
    </>
  );
}
